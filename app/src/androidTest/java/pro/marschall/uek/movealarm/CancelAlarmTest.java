...
public class CancelAlarmTest {
    ...
    public void cancelAlarmTest() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withClassName(is("androidx.appcompat.widget.AppCompatEditText")), withText("15"),
                        childAtPosition(
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withClassName(is("androidx.appcompat.widget.AppCompatEditText")), withText("22"),
                        childAtPosition(
                                allOf(withClassName(is("android.widget.RelativeLayout")),
                                        childAtPosition(
                                                withClassName(is("android.widget.TextInputTimePickerView")),
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withClassName(is("androidx.appcompat.widget.AppCompatEditText")), withText("2"),
                        childAtPosition(
                                allOf(withClassName(is("android.widget.RelativeLayout")),
                                        childAtPosition(
                                                withClassName(is("android.widget.TextInputTimePickerView")),
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.alarmTime), withText("Alarm set for: 6:00 PM"),
                        ...
                        isDisplayed()));
        textView.check(matches(withText("Alarm set for: 6:00 PM")));

        ViewInteraction materialButton3 = onView(
                allOf(withId(R.id.cancelButton), withText("cancel alarm"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.alarmTime), withText("Alarm cancelled"),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
        textView2.check(matches(withText("Alarm cancelled")));
    }
